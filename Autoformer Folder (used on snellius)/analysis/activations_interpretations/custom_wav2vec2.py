...
class Wav2Vec2Attention(nn.Module):
    ...
    def __init__(
        ...
        # Added by Charlotte
        self.individual_heads = HookPoint()
        self.attn_weights = HookPoint()
        self.value_vectors = HookPoint()
    ...
    def forward(
        ...
        if (
            ...
            # self_attention
            key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
            value_states = self.value_vectors(self._shape(self.v_proj(hidden_states), -1, bsz))
        ...
        if output_attentions:
            ...
            # Added by Charlotte: self.attn_weights
            attn_weights = self.attn_weights(attn_weights_reshaped.view(bsz * self.num_heads, tgt_len, src_len))
        else:
        ...
        # Added by Charlotte: self.individual_heads()
        attn_output = self.individual_heads(attn_output.transpose(1, 2))
